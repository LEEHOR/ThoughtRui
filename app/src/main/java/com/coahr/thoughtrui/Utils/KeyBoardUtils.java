...
public class KeyBoardUtils {
     ...
     * @param mContext  上下文
     */
    public static void hideKeybord(View v, Activity mContext) {
        InputMethodManager imm = (InputMethodManager) mContext.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public static  void UpdateUI(View view, final Activity mContext){//解决所有页面   touch所有edittext以外view，自动隐藏键盘  通过decorview可以获取所有子view，循环判断设置touch事件
