package com.coahr.thoughtrui.widgets.Keyboard;
...
public class AnFQNumEditText extends RelativeLayout {
    ...
    public AnFQNumEditText(Context context, AttributeSet attrs) {
        ...
        TypedArray array  = context.obtainStyledAttributes(attrs,R.styleable.AnFQNumEditText);
        MaxNum = array.getInt(R.styleable.AnFQNumEditText_mostCount,100);
        hint = array.getString(R.styleable.AnFQNumEditText_hint);
